  ...
  constructor(props) {
    ...
    _defineProperty(this, "submit", () => {
      ...
      this.formRef.current.validateFields(keys).then(values => {
        ...
        Object(_utils_api__WEBPACK_IMPORTED_MODULE_19__[/* register */ "F"])(username, password).then(r => {
...
function QuickLogin(props) {
  ...
  return __jsx(_components_container__WEBPACK_IMPORTED_MODULE_2__[/* Space */ "b"], {
