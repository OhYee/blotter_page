...
class about_AboutPage extends external_react_default.a.Component {
  ...
  render() {
    return about_jsx(container["d" /* default */], null, about_jsx(global["a" /* Context */].Consumer, null, context => about_jsx(head_default.a, null, about_jsx("title", null, `关于我|${context.blog_name}`))), about_jsx(card_default.a, null, about_jsx(typography_default.a, null, about_jsx(typography_default.a.Paragraph, {
      style: {
        textAlign: 'center'
      }
