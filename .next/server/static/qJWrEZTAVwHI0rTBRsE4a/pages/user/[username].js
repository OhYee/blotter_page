...
class User extends react__WEBPACK_IMPORTED_MODULE_16___default.a.Component {
  ...
  render() {
    ...
    return __jsx(_components_container__WEBPACK_IMPORTED_MODULE_19__[/* default */ "d"], null, __jsx(_utils_global__WEBPACK_IMPORTED_MODULE_20__[/* Context */ "a"].Consumer, null, context => __jsx(next_head__WEBPACK_IMPORTED_MODULE_17___default.a, null, __jsx("title", null, `${this.props.router.query.username}|用户页|${context.blog_name}`))), __jsx(antd_lib_card__WEBPACK_IMPORTED_MODULE_1___default.a, null, __jsx("p", {
      style: {
        textAlign: 'center'
      }
