...
function Table(props) {
  ...
  return __jsx("div", {
    ...
    icon: __jsx(svg["J" /* Triangle */], null),
    size: "small",
    style: {
...
function Collapse(props) {
  ...
  }, collapse_jsx(svg["p" /* Left */], null)), title), collapse_jsx("div", {
...
class about_AboutPage extends external_react_default.a.Component {
  constructor(props) {
    ...
    about_defineProperty(this, "render_pay", () => {
      const socialMedia = [{
        name: 'wechat',
        icon: about_jsx(svg["L" /* Wechat */], null)
      }, {
        name: 'alipay',
