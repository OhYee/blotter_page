...
// EXTERNAL MODULE: ./components/table/index.tsx
...
function Collapse(props) {
  ...
  }, __jsx(svg["r" /* Left */], null)), title), __jsx("div", {
...
class about_AboutPage extends external_react_default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "render_pay", () => {
      const socialMedia = [{
        name: 'wechat',
        icon: about_jsx(svg["N" /* Wechat */], null)
      }, {
        name: 'alipay',
