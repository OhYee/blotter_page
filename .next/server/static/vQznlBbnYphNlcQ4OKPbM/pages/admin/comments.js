...
/* harmony import */ var _utils_moment__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__("RtTr");
...
class AdminComments extends react__WEBPACK_IMPORTED_MODULE_14___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "getData", async () => {
      ...
      var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_17__[/* commentsAdmin */ "k"])(this.state.page, this.state.size);
      this.setState({
        data: r.comments,
        total: r.total,
        loading: false
    ...
    _defineProperty(this, "renderComment", (comment, notReply) => {
      ...
      return __jsx(antd_lib_comment__WEBPACK_IMPORTED_MODULE_7___default.a, {
        ...
        datetime: __jsx(antd_lib_tooltip__WEBPACK_IMPORTED_MODULE_9___default.a, {
          title: Object(_utils_moment__WEBPACK_IMPORTED_MODULE_18__[/* default */ "a"])(comment.time).format('YYYY-MM-DD HH:mm:ss')
        }, __jsx("span", null, Object(_utils_moment__WEBPACK_IMPORTED_MODULE_18__[/* default */ "a"])(comment.time).fromNow())),
  ...
  render() {
    ...
    return __jsx(antd_lib_card__WEBPACK_IMPORTED_MODULE_1___default.a, null, __jsx(_utils_global__WEBPACK_IMPORTED_MODULE_16__[/* Context */ "a"].Consumer, null, context => __jsx(next_head__WEBPACK_IMPORTED_MODULE_15___default.a, null, __jsx("title", null, `评论列表|后台|${context.blog_name}`))), __jsx(antd_lib_list__WEBPACK_IMPORTED_MODULE_3___default.a, {
      ...
      renderItem: (comment, idx) => __jsx(antd_lib_list__WEBPACK_IMPORTED_MODULE_3___default.a.Item, {
        ...
        onClick: async e => {
          const r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_17__[/* commentSet */ "i"])(comment.id, comment.ad, comment.recv, comment.show);
