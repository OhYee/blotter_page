...
/* harmony import */ var _components_dragable_table__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("rEvH");
...
class AdminMenus extends react__WEBPACK_IMPORTED_MODULE_8___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "getData", async () => {
      ...
      var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_13__[/* menus */ "u"])();
      this.setState({
        data: r,
        loading: false
      });
    ...
    _defineProperty(this, "renderTableHead", () => __jsx("div", {
      ...
      onClick: async () => {
        ...
        var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_13__[/* menusSet */ "v"])(this.state.data);
  ...
  render() {
    return __jsx(antd_lib_card__WEBPACK_IMPORTED_MODULE_1___default.a, null, __jsx(_utils_global__WEBPACK_IMPORTED_MODULE_12__[/* Context */ "a"].Consumer, null, context => __jsx(next_head__WEBPACK_IMPORTED_MODULE_9___default.a, null, __jsx("title", null, `菜单列表|后台|${context.blog_name}`))), __jsx(_components_dragable_table__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"], {
