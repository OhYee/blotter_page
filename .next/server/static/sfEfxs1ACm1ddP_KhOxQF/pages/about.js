...
// EXTERNAL MODULE: ./components/input/index.tsx + 3 modules
...
function Table(props) {
  ...
  return table_jsx("div", {
    ...
    icon: table_jsx(svg["A" /* Triangle */], null),
    size: "small",
    style: {
...
class about_AboutPage extends external_react_default.a.Component {
  constructor(props) {
    ...
    about_defineProperty(this, "render_pay", () => {
      const socialMedia = [{
        name: 'wechat',
        icon: about_jsx(svg["C" /* Wechat */], null)
      }, {
        name: 'alipay',
