...
function Collapse(props) {
  ...
  }, __jsx(svg["u" /* Left */], null)), title), __jsx("div", {
...
class about_AboutPage extends external_react_default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "render_pay", () => {
      const socialMedia = [{
        name: 'wechat',
        icon: about_jsx(svg["T" /* Wechat */], null)
      }, {
        name: 'alipay',
