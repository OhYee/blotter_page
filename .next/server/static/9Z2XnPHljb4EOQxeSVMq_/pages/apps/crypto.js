...
function TextInput(props) {
  ...
  return __jsx(container["b" /* Space */], null, __jsx(input_default.a.TextArea, _extends({
    value: value,
    onChange: e => {
...
function Tab(props) {
  ...
  return __jsx(container["b" /* Space */], null, description, keyEnable ? __jsx(external_react_["Fragment"], null, keyString ? __jsx(TextInput, {
    label: keyLabel,
    placeholder: keyPh,
    value: keyDefault,
...
function HashTab(props) {
  ...
  return __jsx(container["b" /* Space */], null, __jsx(radio_default.a.Group, {
...
function TotpTab(props) {
  ...
  return __jsx(container["b" /* Space */], null, __jsx(typography_default.a.Paragraph, null, "\u57FA\u4E8E\u65F6\u95F4\u7684\u4E00\u6B21\u4E00\u5BC6\u7B97\u6CD5(TOTP)\u662F\u4E00\u4E2A\u6839\u636E\u5BC6\u94A5\u4EE5\u53CA\u65F6\u95F4\u751F\u6210\u5BC6\u7801\u7684\u7B97\u6CD5\uFF0C\u5E7F\u6CDB\u7528\u4E8E\u5404\u79CD\u5B89\u5168\u4EE4\u3001\u4E8C\u6B65\u9A8C\u8BC1\u7684\u573A\u666F"), __jsx(container["c" /* TextCenter */], null, __jsx(Countdown_default.a, {
    ...
    onClick: e => calc()
  }, "\u5237\u65B0")), __jsx(container["b" /* Space */], null, __jsx("strong", null, "\u5BC6\u94A5"), __jsx(BytesInput, {
    closure: (g, s) => (keyGetter = g, keySetter = s)
  })));
}
...
class crypto_CryptoApp extends external_react_default.a.Component {
  ...
  render() {
    ...
    return __jsx(container["d" /* default */], null, __jsx(global["a" /* Context */].Consumer, null, context => __jsx(head_default.a, null, __jsx("title", null, `在线密码工具|${context.blog_name}`))), __jsx(card_default.a, null, __jsx(container["b" /* Space */], null, __jsx(alert_default.a, {
      showIcon: true,
      message: "\u63D0\u793A",
