...
class about_AboutPage extends external_react_default.a.Component {
  ...
  render() {
    return about_jsx(container["c" /* default */], null, about_jsx(global["a" /* Context */].Consumer, null, context => about_jsx(head_default.a, null, about_jsx("title", null, `关于我|${context.blog_name}`))), about_jsx(card_default.a, null, about_jsx(typography_default.a, null, about_jsx(typography_default.a.Paragraph, {
      style: {
        textAlign: 'center'
      }
    }, about_jsx(global["a" /* Context */].Consumer, null, context => about_jsx(avatar_default.a, {
      size: 64,
      src: context.avatar,
      style: {
        background: 'unset'
