...
module.exports = __webpack_require__("T8My");
...
var tabs = __webpack_require__("j7zX");
...
// EXTERNAL MODULE: ./node_modules/antd/lib/upload/style/css.js
var upload_style_css = __webpack_require__("e3Np");

// EXTERNAL MODULE: ./node_modules/antd/lib/upload/index.js
var lib_upload = __webpack_require__("B8+X");
var upload_default = /*#__PURE__*/__webpack_require__.n(lib_upload);
...
// EXTERNAL MODULE: external "qiniu-js"
var external_qiniu_js_ = __webpack_require__("eaJb");
...
function BucketSelector(props) {
  ...
  const [buckets, setBuckets] = external_react_default.a.useState([]);

  const initial = () => {
    setLoading(true);
    Object(api["A" /* qiniu_get_buckets */])().then(r => {
      setBuckets(r.buckets);
      if (bucket == '' && r.buckets.length != 0) onChange(r.buckets[0], '');
    }).catch(console.error).finally(() => setLoading(false));
  };

  external_react_default.a.useEffect(initial, []);
  return __jsx(container["a" /* Space */], {
    direction: "horizontal"
  }, __jsx("strong", null, "\u5B58\u50A8\u7A7A\u95F4\uFF1A"), __jsx(select_default.a, {
    value: bucket,
    onChange: b => onChange(b, prefix),
    loading: loading
  }, buckets.map(b => __jsx(select_default.a.Option, {
    key: b,
    value: b
  }, b))), __jsx(button_default.a, {
    onClick: initial,
    icon: __jsx(icons_["SyncOutlined"], {
      spin: loading
    })
    ...
    loading: loading
  }, prefixs.map(p => __jsx(select_default.a.Option, {
    key: p,
    value: p
...
function Upload(props) {
  ...
  const upload = async file => {
    const token = (await Object(api["C" /* qiniu_get_token */])()).token;
    const filename = !!prefix ? `${prefix}/${file.name}` : file.name;
    const observable = external_qiniu_js_["upload"](file, filename, token, {}, {});
  ...
  return __jsx(upload_default.a.Dragger, {
    name: 'file',
    multiple: true,
...
function ImageList(props) {
  ...
  const [images, setImages] = external_react_default.a.useState([]);
  const [marker, setMarker] = external_react_default.a.useState('');
  const [hasNext, setHasNext] = external_react_default.a.useState(false);
  const [loading, setLoading] = external_react_default.a.useState(false);
  const [id, setID] = external_react_default.a.useState(0);
  const refreshRef = external_react_default.a.useRef(() => getData(bucket, prefix, ''));
  ...
  const getData = (b, p, m) => {
    ...
    Object(api["B" /* qiniu_get_images */])(b, p, m, 5).then(r => {
      setID(newID => {
  ...
  external_react_default.a.useEffect(() => getData(bucket, '', ''), [bucket]);
  external_react_default.a.useEffect(() => {
    setImages([]);
    setMarker('');
    setHasNext(false);
  ...
  return __jsx("div", {
  ...
  }, images.map((image, idx) => __jsx(card_default.a, {
    style: {
      width: 128,
      margin: 10
    },
    size: "small",
    cover: __jsx(components_image["a" /* default */], {
      src: image.name,
    ...
    actions: [__jsx(icons_["SaveOutlined"], null), __jsx(popconfirm_default.a, {
      title: "\u786E\u5B9A\u5220\u9664\uFF1F",
      onConfirm: () => {}
  ...
  }, __jsx(typography_default.a.Text, {
    ellipsis: true,
    copyable: true,
    editable: {
      onChange: () => {}
    }
  }, image.name)))), __jsx(button_default.a, {
...
function Qiniu(props) {
  ...
  const [bucket, setBucket] = external_react_default.a.useState('');
  const [prefix, setPrefix] = external_react_default.a.useState('');
  const [ref, setRef] = external_react_default.a.useState(undefined);
  const setState = external_react_default.a.useCallback((b, p) => {
  ...
  }), __jsx(tabs_default.a, {
    defaultValue: defaultTab,
    tabPosition: "left"
  }, __jsx(tabs_default.a.TabPane, {
    tab: "\u4E0A\u4F20\u56FE\u7247",
    key: "upload"
  }, __jsx(Upload, {
    bucket: bucket,
...
/* harmony default export */ var components_upload = (Qiniu);

// EXTERNAL MODULE: ./utils/global.ts
var global = __webpack_require__("dSKx");

// CONCATENATED MODULE: ./pages/admin/images.tsx
...
class images_AdminImages extends external_react_default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      //   loading: false,
  ...
  render() {
    return images_jsx(container["c" /* default */], null, images_jsx(global["a" /* Context */].Consumer, null, context => images_jsx(head_default.a, null, images_jsx("title", null, `图片管理|${context.blog_name}`))), images_jsx(card_default.a, null, images_jsx(components_upload, null)));
  }

}

_defineProperty(images_AdminImages, "defaultProps", {});

/* harmony default export */ var admin_images = __webpack_exports__["default"] = (images_AdminImages);
