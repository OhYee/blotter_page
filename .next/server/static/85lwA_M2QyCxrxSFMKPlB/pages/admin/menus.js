...
class AdminMenus extends react__WEBPACK_IMPORTED_MODULE_8___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "getData", async () => {
      ...
      var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_14__[/* menus */ "u"])();
      this.setState({
        data: r,
        loading: false
      });
    ...
    _defineProperty(this, "renderTableHead", () => __jsx("div", {
      ...
      onClick: async () => {
        ...
        var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_14__[/* menusSet */ "v"])(this.state.data);
