...
class AdminFriendList extends react__WEBPACK_IMPORTED_MODULE_8___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "getData", async () => {
      ...
      var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_14__[/* friends */ "l"])();
      this.setState({
        data: r,
        loading: false
      });
    ...
    _defineProperty(this, "renderTableHead", () => __jsx("div", {
      ...
      onClick: async () => {
        ...
        var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_14__[/* friendsSet */ "m"])(this.state.data);
        Object(_utils_notification__WEBPACK_IMPORTED_MODULE_15__[/* default */ "b"])(r);
        this.setState({
          submitLoading: false
        });
      }
  ...
  render() {
    return __jsx(_components_container__WEBPACK_IMPORTED_MODULE_11__[/* default */ "c"], {
      lg: 20,
      md: 20,
      sm: 24,
      xs: 24
