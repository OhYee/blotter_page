...
/* harmony import */ var _components_if__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("IgCw");
...
class User extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "getData", async () => {
      const user = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_10__[/* info */ "p"])(this.props.router.query.username);
      this.setState({
        user
      });
    });
    ...
    _defineProperty(this, "update", async () => {
      ...
      const r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_10__[/* userSet */ "P"])(username, email, avatar, ns_id, ns_name, ac_name, ac_island, qq, this.state.password);
  ...
  static async getInitialProps(args) {
    const user = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_10__[/* info */ "p"])(args.query.username);
    return {
      user
    };
  }
  ...
  render() {
    ...
    return __jsx(_components_card__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
      neumorphism: true
    }, __jsx(_utils_global__WEBPACK_IMPORTED_MODULE_9__[/* Context */ "a"].Consumer, null, context => __jsx(next_head__WEBPACK_IMPORTED_MODULE_1___default.a, null, __jsx("title", null, `${this.props.router.query.username}|用户页|${context.blog_name}`))), __jsx(_components_container__WEBPACK_IMPORTED_MODULE_3__[/* Flex */ "a"], {
      direction: "TB",
      fullWidth: true
    }, __jsx(_components_avatar__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"], {
      style: {
        fontSize: 128,
        margin: 'auto'
      },
      src: this.state.user.avatar
    }), __jsx(_components_if__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"], {
      condition: this.state.user.self
    }, __jsx(_components_container__WEBPACK_IMPORTED_MODULE_3__[/* Flex */ "a"], null, __jsx(_components_button__WEBPACK_IMPORTED_MODULE_4__[/* default */ "b"], {
      neumorphism: true,
      ...
      onClick: async () => {
        ...
        const r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_10__[/* avatar */ "g"])(this.state.user.email);
        this.setState(state => {
          var {
            user
          } = state;
    ...
    }, "\u66F4\u65B0 QQ \u5934\u50CF")), __jsx(_components_button__WEBPACK_IMPORTED_MODULE_4__[/* default */ "b"], {
      neumorphism: true,
      onClick: () => this.getData()
    }, "\u5237\u65B0\u6570\u636E"))), __jsx(_components_container__WEBPACK_IMPORTED_MODULE_3__[/* Flex */ "a"], {
      direction: "TB",
      fullWidth: true
    }, fields.map(item => this.state.user.self ? __jsx(_components_input__WEBPACK_IMPORTED_MODULE_6__[/* default */ "j"], {
      key: item.key,
      label: item.name,
      prefix: item.prefix,
      suffix: item.suffix,
    ...
    }) : __jsx("p", null, item.prefix, " ", this.state.user[item.key], " ", item.suffix))), __jsx(_components_if__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"], {
      condition: this.state.user.self
    }, __jsx(_components_container__WEBPACK_IMPORTED_MODULE_3__[/* Flex */ "a"], null, __jsx(_components_input__WEBPACK_IMPORTED_MODULE_6__[/* default */ "j"], {
      type: "password",
      ...
      neumorphism: true
    }, "\u7ED1\u5B9A QQ \u767B\u5F55")) : __jsx(_components_button__WEBPACK_IMPORTED_MODULE_4__[/* default */ "b"], {
      neumorphism: true,
      disabled: true
    }, "\u5DF2\u7ED1\u5B9A QQ \u767B\u5F55"), !this.state.user.github_connected ? __jsx("a", {
      href: "/api/user/jump_to_github?state=connect",
      target: "_blank"
    }, __jsx(_components_button__WEBPACK_IMPORTED_MODULE_4__[/* default */ "b"], {
      neumorphism: true
    }, "\u7ED1\u5B9A Github \u767B\u5F55")) : __jsx(_components_button__WEBPACK_IMPORTED_MODULE_4__[/* default */ "b"], {
      neumorphism: true,
      disabled: true
    }, "\u5DF2\u7ED1\u5B9A Github \u767B\u5F55"), __jsx(_components_button__WEBPACK_IMPORTED_MODULE_4__[/* default */ "b"], {
      neumorphism: true,
...
_defineProperty(User, "contextType", _utils_global__WEBPACK_IMPORTED_MODULE_9__[/* Context */ "a"]);
