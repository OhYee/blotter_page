...
class AdminMenus extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
    ...
    _defineProperty(this, "getData", async () => {
      ...
      var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_10__[/* menus */ "u"])();
      this.setState({
        data: r,
        loading: false
      });
    ...
    _defineProperty(this, "renderEditableCell", (idx, key) => {
      return __jsx(_components_input__WEBPACK_IMPORTED_MODULE_6__[/* default */ "j"], {
        transform: true,
    ...
    _defineProperty(this, "columns", [{
      ...
      minWidth: '5em',
      maxWidth: '10em',
      render: (value, record) => __jsx(_components_svg__WEBPACK_IMPORTED_MODULE_7__[/* default */ "U"], {
        icon: record.icon
      })
    }, {
      key: 'op',
      title: '操作',
      render: (_, record, idx) => __jsx(_components_popover__WEBPACK_IMPORTED_MODULE_4__[/* default */ "d"], {
        shadow: true,
        card: true,
        trigger: ['click'],
        component: __jsx(_components_card__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], null, __jsx("span", null, "\u771F\u7684\u8981\u5220\u9664\u4E48\uFF1F"), __jsx(_components_button__WEBPACK_IMPORTED_MODULE_3__[/* default */ "b"], {
          onClick: () => {
            this.setState(state => {
              var data = state.data;
        ...
        danger: true,
        neumorphism: true,
        prefix: __jsx(_components_svg__WEBPACK_IMPORTED_MODULE_7__[/* Delete */ "g"], null)
      }, "\u5220\u9664"))
    }]);

    _defineProperty(this, "renderTableHead", () => __jsx(_components_container__WEBPACK_IMPORTED_MODULE_8__[/* Flex */ "a"], {
      mainAxis: "flex-end"
    }, __jsx(_components_button__WEBPACK_IMPORTED_MODULE_3__[/* default */ "b"], {
      neumorphism: true,
      onClick: () => {
      ...
      prefix: __jsx(_components_svg__WEBPACK_IMPORTED_MODULE_7__[/* Plus */ "C"], null)
    }, "\u65B0\u5EFA"), __jsx(_components_button__WEBPACK_IMPORTED_MODULE_3__[/* default */ "b"], {
      neumorphism: true,
      primary: true,
      ...
      onClick: async () => {
        ...
        var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_10__[/* menusSet */ "v"])(this.state.data);
        Object(_utils_notification__WEBPACK_IMPORTED_MODULE_11__[/* default */ "b"])(r);
        this.setState({
          submitLoading: false
        });
      },
      prefix: __jsx(_components_svg__WEBPACK_IMPORTED_MODULE_7__[/* Save */ "J"], null)
    }, "\u4FDD\u5B58\u4FEE\u6539")));
