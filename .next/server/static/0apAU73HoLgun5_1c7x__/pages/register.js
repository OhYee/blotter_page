...
/* harmony import */ var _components_auth__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("aZ+T");
...
class Register extends react__WEBPACK_IMPORTED_MODULE_14___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "submit", () => {
      ...
      this.formRef.current.validateFields(keys).then(values => {
        ...
        Object(_utils_api__WEBPACK_IMPORTED_MODULE_18__[/* register */ "F"])(username, password).then(r => {
          if (Object(_utils_notification__WEBPACK_IMPORTED_MODULE_19__[/* default */ "b"])(r)) {
            window.close();
          }
  ...
  render() {
    return __jsx(antd_lib_card__WEBPACK_IMPORTED_MODULE_1___default.a, null, __jsx(_utils_global__WEBPACK_IMPORTED_MODULE_17__[/* Context */ "a"].Consumer, null, context => __jsx(next_head__WEBPACK_IMPORTED_MODULE_15___default.a, null, __jsx("title", null, `注册|${context.blog_name}`))), __jsx(antd_lib_form__WEBPACK_IMPORTED_MODULE_7___default.a, {
      layout: "vertical",
      ref: this.formRef
      ...
      rules: [{
        ...
        validator: async (_, value) => (await Object(_utils_api__WEBPACK_IMPORTED_MODULE_18__[/* checkUsername */ "h"])(value)).existed ? Promise.reject('该用户名已被使用') : Promise.resolve()
      }]
    ...
    }, "\u7528\u6237\u534F\u8BAE"))), __jsx(antd_lib_form__WEBPACK_IMPORTED_MODULE_7___default.a.Item, null, __jsx(_components_auth__WEBPACK_IMPORTED_MODULE_16__[/* default */ "a"], null), __jsx("span", {
      style: {
        float: 'right'
      }
