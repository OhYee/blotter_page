...
class crypto_CryptoApp extends external_react_default.a.Component {
  ...
  render() {
    ...
    return __jsx(card_default.a, null, __jsx(global["a" /* Context */].Consumer, null, context => __jsx(head_default.a, null, __jsx("title", null, `在线密码工具|${context.blog_name}`))), __jsx(container["b" /* Space */], null, __jsx(alert_default.a, {
      showIcon: true,
      message: "\u63D0\u793A",
