...
// EXTERNAL MODULE: ./components/input/index.tsx + 5 modules
...
function Table(props) {
  ...
  if (!!loading) return loading === true ? __jsx(components_loading["a" /* default */], null) : loading; // 将简写的列拓展为标准的 Column 类型
  ...
  return __jsx("div", {
    ...
    icon: __jsx(svg["F" /* Triangle */], null),
    size: "small",
    style: {
    ...
    key: col.key,
    style: col.footStyle
  }, !col.footer ? null : typeof col.footer === 'function' ? col.footer(col.key) : col.footer)))) : null), pagination !== false ? __jsx(components_pagination["a" /* default */], _extends({}, paginationProps, {
    style: _objectSpread({
      margin: 5
  ...
  })) : null, __jsx(popover["a" /* Modal */], {
    show: filterModal !== false,
    onClose: () => setFilterModal(false)
  }, filterModal === false ? null : __jsx("div", null, __jsx(container["a" /* Flex */], {
    direction: "TB",
    fullWidth: true
    ...
    subAxis: "center",
    subSize: "middle"
  }, filterModal.filter.filters.map(item => __jsx(input["a" /* CheckBox */], {
    key: item,
  ...
  }, "\u53D6\u6D88\u7B5B\u9009"), __jsx(components_button["b" /* default */], {
    onClick: () => {
...
function Collapse(props) {
  ...
  }, collapse_jsx(svg["n" /* Left */], null)), title), collapse_jsx("div", {
...
class about_AboutPage extends external_react_default.a.Component {
  constructor(props) {
    ...
    about_defineProperty(this, "render_pay", () => {
      const socialMedia = [{
        name: 'wechat',
        icon: about_jsx(svg["H" /* Wechat */], null)
      }, {
        name: 'alipay',
