...
class about_AboutPage extends external_react_default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "render_pay", () => {
      const socialMedia = [{
        name: 'wechat',
        icon: /*#__PURE__*/Object(jsx_runtime_["jsx"])(svg["W" /* Wechat */], {})
      }, {
        name: 'alipay',
  ...
  async componentDidMount() {
    if (!!this.props.github) {
      ...
      try {
        var repos = (await Object(api["o" /* githubRepos */])(this.props.github)).repos;
      } catch {
        repos = [];
      }
