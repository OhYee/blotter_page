...
class User extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "getData", async () => {
      const user = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_11__[/* info */ "s"])(this.props.router.query.username);
      this.setState({
        user
      });
    });
    ...
    _defineProperty(this, "update", async () => {
      ...
      const r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_11__[/* userSet */ "T"])(username, email, avatar, ns_id, ns_name, ac_name, ac_island, qq, this.state.password);
  ...
  static async getInitialProps(args) {
    const user = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_11__[/* info */ "s"])(args.query.username);
    return {
      user
    };
  }
