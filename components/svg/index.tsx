...
export function Filter(props: { style?: React.CSSProperties; className?: string }) {
  const { style, className } = props;
  return (
    <SVG style={style} className={className}>
      <svg viewBox="0 0 1024 1024" fill="currentColor">
...
export function Loading(props: { style?: React.CSSProperties; className?: string }) {
  const { style, className } = props;
  return (
    <SVG style={style} className={className}>
      <svg
...
export function Disconnect(props: { style?: React.CSSProperties; className?: string }) {
  const { style, className } = props;
  return (
    <SVG style={style} className={className}>
      <svg viewBox="64 64 896 896" data-icon="disconnect" fill="currentColor">
