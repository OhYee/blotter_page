  ...
  render() {
    var _this$props = this.props,
      ...
      moveRow
        ...
        rest = _objectWithoutProperties(_this$props, ["connectDragSource", "connectDropTarget", "moveRow"]);

    var style = _objectSpread({}, this.props.style, {
      cursor: 'move'
    });

    return connectDragSource(connectDropTarget(__jsx("tr", _extends({}, rest, {
      style: style
    }))));
  }
...
/* harmony default export */ var draggable_table = (draggable_table_DraggableTable);
...
class friends_AdminFriendList extends external_react_default.a.Component {
  constructor(props) {
    ...
    friends_defineProperty(this, "renderExpand", (record, index, indent, expanded) => {
      ...
      return friends_jsx(draggable_table, {
  ...
  render() {
    return friends_jsx(container["a" /* default */], {
      ...
      sm: 24,
      xs: 24
    }, friends_jsx(global["a" /* Context */].Consumer, null, context => friends_jsx(head_default.a, null, friends_jsx("title", null, `友链列表|后台|${context.blog_name}`))), friends_jsx(card_default.a, null, friends_jsx(draggable_table, {
