  ...
  constructor(props) {
    ...
    _defineProperty(this, "submit", () => {
      ...
      this.formRef.current.validateFields(keys).then(async values => {
        ...
        const r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_18__[/* register */ "z"])(username, password);
        Object(_utils_notification__WEBPACK_IMPORTED_MODULE_19__[/* default */ "a"])(r);
        this.setState({
          loading: false
        });
      });
