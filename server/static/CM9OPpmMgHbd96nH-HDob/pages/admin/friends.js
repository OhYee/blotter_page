...
class friends_AdminFriendList extends external_react_default.a.Component {
  ...
  render() {
    return friends_jsx(container["a" /* default */], {
      ...
      sm: 24,
      xs: 24
    }, friends_jsx(global["a" /* Context */].Consumer, null, context => friends_jsx(head_default.a, null, friends_jsx("title", null, `友链列表|后台|${context.blog_name}`))), friends_jsx(card_default.a, null, friends_jsx(draggable_table_DraggableTable, {
