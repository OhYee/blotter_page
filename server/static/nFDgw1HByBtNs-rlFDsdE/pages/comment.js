...
class CommentPage extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  render() {
    return __jsx(_components_container__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
      lg: 16
    }, __jsx(_utils_global__WEBPACK_IMPORTED_MODULE_7__[/* Context */ "a"].Consumer, null, context => __jsx(next_head__WEBPACK_IMPORTED_MODULE_3___default.a, null, __jsx("title", null, `评论区|${context.blog_name}`))), __jsx(antd_lib_card__WEBPACK_IMPORTED_MODULE_1___default.a, null, __jsx(_components_comment__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
...
class CommentPart extends react__WEBPACK_IMPORTED_MODULE_18___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "initialComment", () => {
      ...
      Object(_utils_api__WEBPACK_IMPORTED_MODULE_21__[/* comments */ "g"])(this.props.url, data => {
        this.setState(() => ({
          total: data.total,
    ...
    _defineProperty(this, "onEmailBlur", (id, formRef) => {
      Object(_utils_api__WEBPACK_IMPORTED_MODULE_21__[/* avatar */ "f"])(formRef.current.getFieldValue(`email`), data => this.setState(state => {
    ...
    _defineProperty(this, "onSubmitClick", async (id, formRef) => {
      ...
      var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_21__[/* addComment */ "a"])({
        url: this.props.url,
        reply: id,
        email: value['email'],
        recv: value['recv'],
