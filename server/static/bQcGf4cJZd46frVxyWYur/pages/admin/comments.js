...
class AdminComments extends react__WEBPACK_IMPORTED_MODULE_14___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "getData", async () => {
      ...
      var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_18__[/* commentsAdmin */ "j"])(this.state.page, this.state.size);
      this.setState({
        data: r.comments,
        total: r.total,
        loading: false
  ...
  render() {
    ...
    return __jsx(_components_container__WEBPACK_IMPORTED_MODULE_16__[/* default */ "a"], {
      ...
      renderItem: (comment, idx) => __jsx(antd_lib_list__WEBPACK_IMPORTED_MODULE_3___default.a.Item, {
        ...
        onClick: async e => {
          const r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_18__[/* commentSet */ "h"])(comment.id, comment.ad, comment.recv, comment.show);
