...
class variables_AdminVariables extends external_react_default.a.Component {
  ...
  async componentDidMount() {
    ...
    var r = await Object(api["A" /* variables */])();
    var obj = {};
  ...
  render() {
    return variables_jsx(container["a" /* default */], {
      ...
      sm: 24,
      xs: 24
    }, variables_jsx(global["a" /* Context */].Consumer, null, context => variables_jsx(head_default.a, null, variables_jsx("title", null, `变量列表|后台|${context.blog_name}`))), variables_jsx(card_default.a, {
      style: {
        overflow: 'auto'
      }
    }, variables_jsx("div", {
      ...
      onClick: async () => {
        ...
        var r = await Object(api["B" /* variablesSet */])(data);
