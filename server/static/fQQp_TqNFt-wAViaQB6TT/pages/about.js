...
var HookModal = function HookModal(_ref, ref) {
  ...
  return React.createElement(_LocaleReceiver["default"], {
    ...
    return React.createElement(_ConfirmDialog["default"], _extends({}, innerConfig, {
      close: close,
      visible: visible,
...
var _cssAnimation = _interopRequireDefault(__webpack_require__("XcIF"));
...
var style_css = __webpack_require__("3UVQ");
...
var descriptions_style_css = __webpack_require__("755D");
...
var popover_style_css = __webpack_require__("w0MD");
...
class about_AboutPage extends external_react_default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "render_pay", () => {
      return about_jsx(list_default.a, {
        dataSource: [{
          name: 'wechat',
          icon: about_jsx(icons_["WechatOutlined"], null)
        }, {
          name: 'alipay',
          icon: about_jsx(icons_["AlipayOutlined"], null)
        }],
        grid: {
          column: 2
        },
    ...
    _defineProperty(this, "render_social", () => {
      ...
      return about_jsx(list_default.a, {
        ...
        renderItem: item => about_jsx(list_default.a.Item, {
          key: item.name
        }, about_jsx("a", {
          href: item.link,
          target: "_blank"
        }, about_jsx(popover_default.a, {
          content: item.name
        }, about_jsx("span", {
    ...
    _defineProperty(this, "render_projects", () => {
      ...
      const columns = [{
        ...
        render(text) {
          return external_moment_default()(text).format('YYYY-MM-DD hh:mm:ss');
        },
  ...
  async componentDidMount() {
    if (!!this.props.github) {
      ...
      for (var i = 1;; i++) {
        var r = await Object(api["k" /* githubRepos */])(this.props.github, i);
        if (r.length == 0) break;
  ...
  render() {
    return about_jsx(container["a" /* default */], null, about_jsx(global["a" /* Context */].Consumer, null, context => about_jsx(head_default.a, null, about_jsx("title", null, `关于我|${context.blog_name}`))), about_jsx(card_default.a, null, about_jsx(typography_default.a, null, about_jsx(typography_default.a.Paragraph, {
      style: {
        textAlign: 'center'
      }
    }, about_jsx(avatar_default.a, {
      size: 64,
      src: "/static/img/logo.svg"
    }), about_jsx("br", null), about_jsx(typography_default.a.Text, {
      strong: true
    }, this.props.author)), about_jsx(components_if["a" /* default */], {
      condition: !!this.props.quote
    }, about_jsx(typography_default.a.Paragraph, {
      style: {
        textAlign: 'center'
      }
    }, about_jsx("em", {
    ...
    }))), about_jsx(typography_default.a.Paragraph, null, this.render_pay()), about_jsx(typography_default.a.Paragraph, null, this.render_social()), about_jsx(collapse_default.a, {
...
var Collapse = /*#__PURE__*/function (_React$Component) {
  ...
  function Collapse() {
    ...
    _this.renderExpandIcon = function () {
      ...
      var icon = expandIcon ? expandIcon(panelProps) : React.createElement(_RightOutlined["default"], {
...
function useModal() {
  ...
  function getConfirmFunc(withFunc) {
    return function hookConfirm(config) {
      ...
      var closeFunc;
      var modal = React.createElement(_HookModal["default"], {
