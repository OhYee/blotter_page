...
class User extends react__WEBPACK_IMPORTED_MODULE_18___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "update", async () => {
      ...
      const r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_23__[/* userSet */ "F"])(username, email, avatar, ns_id, ns_name, ac_name, ac_island, qq, this.state.password);

      if (Object(_utils_notification__WEBPACK_IMPORTED_MODULE_24__[/* default */ "a"])(r)) {
  ...
  static async getInitialProps(args) {
    const user = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_23__[/* info */ "p"])(args.query.username);
    return {
      user
    };
  }
  ...
  render() {
    ...
    }, __jsx(antd_lib_col__WEBPACK_IMPORTED_MODULE_13___default.a, null, !this.state.user.qq_connected ? __jsx("a", {
