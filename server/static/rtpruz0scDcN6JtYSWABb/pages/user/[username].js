...
class User extends react__WEBPACK_IMPORTED_MODULE_16___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "update", async () => {
      ...
      const r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_21__[/* userSet */ "F"])(username, email, avatar, ns_id, ns_name, ac_name, ac_island, qq, this.state.password);
  ...
  render() {
    ...
    return __jsx(_components_container__WEBPACK_IMPORTED_MODULE_19__[/* default */ "c"], null, __jsx(_utils_global__WEBPACK_IMPORTED_MODULE_20__[/* Context */ "a"].Consumer, null, context => __jsx(next_head__WEBPACK_IMPORTED_MODULE_17___default.a, null, __jsx("title", null, `${this.props.router.query.username}|用户页|${context.blog_name}`))), __jsx(antd_lib_card__WEBPACK_IMPORTED_MODULE_1___default.a, null, __jsx("p", {
      ...
      disabled: true
    }, "\u5DF2\u7ED1\u5B9A QQ \u767B\u5F55")), __jsx(antd_lib_col__WEBPACK_IMPORTED_MODULE_9___default.a, {
      style: {
        textAlign: 'right'
      }
    }, __jsx(antd_lib_button__WEBPACK_IMPORTED_MODULE_13___default.a, {
