...
class variables_AdminVariables extends external_react_default.a.Component {
  ...
  render() {
    return variables_jsx(container["a" /* default */], {
      ...
      sm: 24,
      xs: 24
    }, variables_jsx(global["a" /* Context */].Consumer, null, context => variables_jsx(head_default.a, null, variables_jsx("title", null, `变量列表|后台|${context.blog_name}`))), variables_jsx(card_default.a, null, variables_jsx(external_react_dnd_["DndProvider"], {
