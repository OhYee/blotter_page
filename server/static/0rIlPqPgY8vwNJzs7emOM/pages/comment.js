...
class CommentPart extends react__WEBPACK_IMPORTED_MODULE_20___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "initialComment", () => {
      ...
      Object(_utils_api__WEBPACK_IMPORTED_MODULE_22__[/* comments */ "f"])(this.props.url, data => {
        this.setState(() => ({
          total: data.total,
    ...
    _defineProperty(this, "onEmailBlur", id => {
      ...
      Object(_utils_api__WEBPACK_IMPORTED_MODULE_22__[/* avatar */ "e"])(this.props.form.getFieldValue(`email${id}`), data => this.setState(state => {
