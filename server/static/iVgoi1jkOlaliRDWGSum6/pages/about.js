...
// CONCATENATED MODULE: ./components/if.tsx
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }



class if_If extends external_react_default.a.Component {
  constructor(props) {
    super(props);
  }
...
_defineProperty(if_If, "defaultProps", {
  condition: true
});

/* harmony default export */ var components_if = (if_If);
...
class about_AboutPage extends external_react_default.a.Component {
  ...
  componentDidMount() {
    if (!!this.props.github) {
      Object(api["k" /* githubRepos */])(this.props.github, data => {
        this.setState({
          repos: data
        });
      });
  ...
  render() {
    return about_jsx(container["a" /* default */], null, about_jsx(global["a" /* Context */].Consumer, null, context => about_jsx(head_default.a, null, about_jsx("title", null, `关于我|${context.blog_name}`))), about_jsx(card_default.a, null, about_jsx(typography_default.a, null, about_jsx(typography_default.a.Paragraph, {
      ...
      strong: true
    }, this.props.author)), about_jsx(components_if, {
