...
class AdminFriendList extends react__WEBPACK_IMPORTED_MODULE_8___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "getData", async () => {
      ...
      var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_12__[/* friends */ "i"])();
      this.setState({
        data: r,
        loading: false
      });
    ...
    _defineProperty(this, "renderTableHead", () => __jsx("div", {
      ...
      onClick: async () => {
        ...
        var r = await Object(_utils_api__WEBPACK_IMPORTED_MODULE_12__[/* friendsSet */ "j"])(this.state.data);
